...
export const isLoanDestination=(a:Pick<Account,'type'|'archivedAt'>)=>!a.archivedAt&&['bank_loan','microloan','mortgage','personal_debt'].includes(a.type)
...
/** Money sources exclude manually tracked non-card debts. */
export const isPaymentAccount=(a:Pick<Account,'type'|'archivedAt'>)=>!a.archivedAt&&!isLoanDestination(a)
