        ...
        <div className="flex gap-2">
          ...
          <Popover open={dateRangeOpen} onOpenChange={setDateRangeOpen}>
            ...
            <PopoverContent className="w-auto p-0 z-[100]" align="end" side="bottom" sideOffset={8}>
              <div className="p-3 space-y-3 bg-glass-dropdown border border-glass rounded-lg shadow-lg">
          ...
          <Popover open={categoryFilterOpen} onOpenChange={setCategoryFilterOpen}>
            ...
            <PopoverContent className="w-64 z-[100]" align="end" side="bottom" sideOffset={8}>
              <div className="space-y-3 bg-glass-dropdown border border-glass rounded-lg shadow-lg p-3">
